...
.controller('vendorCtrl', function($http, $scope, Chats, $ionicModal) {
    var vm = this
    // console.log(io)
    vm.socket = io( "http://192.168.0.11:3000" )
...
$scope.addNewItem =function(){
  ...
  $http({
    method: "POST",
    url: "http://192.168.0.11:3000/items/one",
    data: {
...
.controller('clientCtrl', function($scope, $stateParams, $location, $http, $rootScope, $timeout) {
  ...
  $http({
    method: 'GET'
    ,url: "http://192.168.0.11:3000/items"
  })
  .then(function(items){
    console.log('y');
    console.log(items);
  ...
  vm.socket = io.connect('http://192.168.0.11:3000/api')
...
.controller('paymentCtrl', function($scope, $rootScope, $http){
  ...
  var vm = this
    ...
    $scope.getToken = function () {
      $http({
        method: 'POST'
        ,url: 'http://192.168.0.11:3000/payments/token'
        ,data: {}
